...
class ENet(nn.Module):
    def __init__(self, args):
        ...
        self.geoplanes = 3
        self.SparseConvNet1 = SparseConvNet(input_channels = 32)
        self.SparseConvNet2 = SparseConvNet(input_channels = 128)
        self.SparseConvNet3 = SparseConvNet(input_channels = 256)
        self.SparseConvNet4 = SparseConvNet(input_channels = 512)
        self.SparseConvNet5 = SparseConvNet(input_channels = 1024)
    ...
    def forward(self, input):
        ...
        mask = (sparsed_feature > 0).float()
        sparsed_feature = self.SparseConvNet1(sparsed_feature, mask)
        ...
        mask2 = (sparsed_feature2_plus > 0).float()
        sparsed_feature2_plus = self. SparseConvNet2(sparsed_feature2_plus, mask2)
        ...
        mask4 = (sparsed_feature4_plus > 0).float()
        sparsed_feature4_plus = self.SparseConvNet3(sparsed_feature4_plus, mask4)
        ...
        mask6 = (sparsed_feature6_plus > 0).float()
        sparsed_feature6_plus = self.SparseConvNet4(sparsed_feature6_plus, mask6)
        ...
        mask8 = (sparsed_feature8_plus > 0).float()
        sparsed_feature8_plus = self.SparseConvNet5(sparsed_feature8_plus, mask8)
